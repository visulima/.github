...
This policy applies to every Visulima repository that does not ship its own `SECURITY.md`.
...
In scope: code in Visulima repositories and the packages published from them, including their build and release pipelines.
